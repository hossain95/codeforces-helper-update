document.getElementById("formCompareProfile").addEventListener("submit", (e)=>
{
    ...
    (async() =>
    {
        try
        {
            ...
            document.getElementById("id1").innerText = handle1;
            document.getElementById("id2").innerText = handle2;
            document.getElementById("id3").innerText = handle1;
            document.getElementById("id4").innerText = handle2;
